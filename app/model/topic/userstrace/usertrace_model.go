...
// arModel is a active record design model for table guaniu_study_users operations.
type arModel struct {
	gmvc.M
}
...
var (
	// Table is the table name of guaniu_study_trace.
	Table = "guaniu_study_trace"
	// Model is the model object of guaniu_study_trace.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_trace.
	Columns = struct {
		Id     string // 主键                                   
        Uid    string // 用户主键                               
        Type   string // 类型(0:注册1::登录2:退出3:修改4:删除)  
        Ip     string // ip                                     
        Ext    string // 扩展字段                               
        Ctime  string // 注册时间
	}{
