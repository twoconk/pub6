...
// arModel is a active record design model for table guaniu_study_book_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_book_category.
	Table = "guaniu_study_book_category"
	// Model is the model object of guaniu_study_book_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_book_category.
	Columns = struct {
		Id              string // 编号
		BookId          string // 主题id
		CatgoryName     string // 目录：第1章 核心套路篇
		CatgoryPage     string // 页码
		CreateTime      string // 时间
		TopicTableIndex string // 表id 与表topic 相关
	}{
		Id:              "id",
		BookId:          "book_id",
		CatgoryName:     "catgory_name",
		CatgoryPage:     "catgory_page",
