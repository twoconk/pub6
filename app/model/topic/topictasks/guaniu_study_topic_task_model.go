...
// arModel is a active record design model for table guaniu_study_topic_task operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_task.
	Table = "guaniu_study_topic_task"
	// Model is the model object of guaniu_study_topic_task.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_task.
	Columns = struct {
		Id              string // 编号
		TopicId         string // 主题id
		...
		ResourceTypeId  string // 关联资源类型，关联字典表
		BookId          string // 书的id
		BookCatgoryId   string // 书的目录id
