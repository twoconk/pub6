...
// arModel is a active record design model for table guaniu_study_topic operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic.
	Table = "guaniu_study_topic"
	// Model is the model object of guaniu_study_topic.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic.
	Columns = struct {
		Id               string // 编号                          
        ParentId         string // 父主题id                      
        TopicType        string // 主题类型                      
        TopicName        string // 主题名称                      
        TopicPinyin      string // 主题名称拼音                  
        TopicImg         string // 主题图片路径                  
        TopicContent     string // 主题描述                      
        OrderNum         string // 显示顺序                      
        SeeNum         string // 显示人数                      
        Status           string // 是否开放状态（0正常 1 关闭）  
        CreateOwnerId    string // 创建者                        
        CreateTime       string // 时间                          
        ModifyTime       string // 时间                          
        MembersNumber    string // 加入成员数                    
