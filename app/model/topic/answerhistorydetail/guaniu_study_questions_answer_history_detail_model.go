...
// arModel is a active record design model for table guaniu_study_questions_answer_history_detail operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_questions_answer_history_detail.
	Table = "guaniu_study_questions_answer_history_detail"
	// Model is the model object of guaniu_study_questions_answer_history_detail.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_questions_answer_history_detail.
	Columns = struct {
		Id             string // 编号
		HistoryId      string // 答题记录id
		QuestionId     string // 问题id
		QuestionAnswer string // 描述题答案
		TopicId        string // 主题id
		AnswerRight    string // 1:准确，2错误  3未知
	}{
		Id:             "id",
