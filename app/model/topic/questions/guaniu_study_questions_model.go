...
// arModel is a active record design model for table guaniu_study_questions operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_questions.
	Table = "guaniu_study_questions"
	// Model is the model object of guaniu_study_questions.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_questions.
	Columns = struct {
		Id                 string // 编号
		TopicId            string // 主题id
		TaskId             string // 任务id
		QuestionType       string // 选择题0, 1:对错题  2:填空题
		QuestionTitle      string // 问题
		OptionA            string // 描述A
		OptionB            string // 描述B
		OptionC            string // 描述C
		OptionD            string // 描述D
		OptionE            string // 描述E
		Answer1            string // 选择题答案
		Answer2            string // 描述题答案
		Answer3            string // 对错题答案
		QuestionAnswerDesc string // 问题描述
		QuestionDiff       string // 题目难度 1，越大越难
		CreateOwnerId      string // 创建者
		CreateTime         string // 时间
		ModifyTime         string // 时间
		TopicTableIndex    string // 表id 与表topic 相关
	}{
		Id:                 "id",
		TopicId:            "topic_id",
		TaskId:             "task_id",
		...
		Answer2:            "answer2",
		Answer3:            "answer3",
		QuestionAnswerDesc: "question_answer_desc",
		QuestionDiff:       "question_diff",
		CreateOwnerId:      "create_owner_id",
		CreateTime:         "create_time",
		ModifyTime:         "modify_time",
		TopicTableIndex:    "topic_table_index",
	}
)
