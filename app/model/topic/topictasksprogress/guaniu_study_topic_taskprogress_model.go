...
// arModel is a active record design model for table guaniu_study_topic_taskprogress operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_taskprogress.
	Table = "guaniu_study_topic_taskprogress"
	// Model is the model object of guaniu_study_topic_taskprogress.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_taskprogress.
	Columns = struct {
		Id               string // 编号                  
        TopicId          string // 主题id                
        TaskId           string // 任务id                
        UserId           string // 用户id                
        Content          string // 进度补充描述          
        Status           string // 状态（0开始 1 完成）  
