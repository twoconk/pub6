...
// Entity is the golang structure for table guaniu_study_topic_taskprogress.
type Entity struct {
	...
	Content         string      `orm:"content"           json:"content"`           // 进度补充描述
	Status          int         `orm:"status"            json:"status"`            // 状态（0开始 1 完成）
