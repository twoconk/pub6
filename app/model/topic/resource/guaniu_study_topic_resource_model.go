...
// arModel is a active record design model for table guaniu_study_topic_resource operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_resource.
	Table = "guaniu_study_topic_resource"
	// Model is the model object of guaniu_study_topic_resource.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_resource.
	Columns = struct {
		Id              string // 编号
		TopicId         string // 主题id
		UserId          string // 用户id
		ResourceTypeId  string // 关联资源类型，资源类型1.公开网课/2.付费网课/3.专业书籍/4.文档材料/5.其他类型
		BookId          string // 书的id
		ResourceContent string // 资源内容，可以是资源链接
		ResourceLink   string 
		Status          string // 是否开放状态（0正常 1 禁言）
