...
var (
	// Table is the table name of guaniu_study_users.
	Table = "guaniu_study_users"
	// Model is the model object of guaniu_study_users.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_users.
	Columns = struct {
		Id     string // 主键
		Name   string // 用户名
		Email  string // 邮箱
		...
		Salt   string // 盐值
		Ext    string // 扩展字段
		Status string // 状态（0：未审核,1:通过 10删除）
		Ctime  string // 创建时间
		Mtime  string // 修改时间
	}{
		Id:     "id",
