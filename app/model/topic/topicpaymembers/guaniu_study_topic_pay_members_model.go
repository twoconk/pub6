...
// arModel is a active record design model for table guaniu_study_topic_pay_members operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_pay_members.
	Table = "guaniu_study_topic_pay_members"
	// Model is the model object of guaniu_study_topic_pay_members.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_pay_members.
	Columns = struct {
		Id              string // 编号
		TopicId         string // 主题id
		UserId          string // 加入用户id
