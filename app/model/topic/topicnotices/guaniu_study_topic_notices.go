...
type AddReq struct {
	...
	NoticeDesc        string      `p:"noticeDesc" `
...
type SelectPageReq struct {
	...
	UserId          int64         `p:"userId" `
	NoticeDesc        string `p:"NoticeDesc"`        //公告内容
...
func AddSave(req *AddReq) error {
	...
	entity.NoticeDesc = req.NoticeDesc
...
func SelectListByPage(req *SelectPageReq) (total int, page int64, list []*Entity, err error) {
	...
	if req != nil {
		if req.NoticeDesc != "" {
			model = model.Where("book_desc = ?", req.NoticeDesc)
		}
		if req.TopicId != 0 {
...
func SelectListAll(req *SelectPageReq) (list []*Entity, err error) {
	...
	if req != nil {
		if req.NoticeDesc != "" {
			model.Where("book_desc = ?", req.NoticeDesc)
		}
	}
	// 查询
