...
// arModel is a active record design model for table guaniu_study_topic_notices operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_notices.
	Table = "guaniu_study_topic_notices"
	// Model is the model object of guaniu_study_topic_notices.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_notices.
	Columns = struct {
		Id              string // 编号
		TopicId         string // 主题id
		UserId          string // 发起用户
		BookDesc        string // 公告内容
