...
// Entity is the golang structure for table guaniu_study_topic_notices.
type Entity struct {
    Id              int64       `orm:"id,primary"        json:"id"`                // 编号                 
    TopicId         int64       `orm:"topic_id"          json:"topic_id"`          // 主题id               
    UserId          int64         `orm:"user_id"           json:"user_id"`           // 发起用户             
    NoticeDesc        string      `orm:"notice_desc"         json:"notice_desc"`         // 公告内容             
