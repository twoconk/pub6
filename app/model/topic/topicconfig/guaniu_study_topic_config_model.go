...
// arModel is a active record design model for table guaniu_study_topic_config operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of guaniu_study_topic_config.
	Table = "guaniu_study_topic_config"
	// Model is the model object of guaniu_study_topic_config.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table guaniu_study_topic_config.
	Columns = struct {
		Id              string // 编号
		TopicId         string // 主题id
